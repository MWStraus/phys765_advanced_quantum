...
if __name__ == "__main__":
    ...
    mu_max = 0.5
    beta = 100
    mu_zoom_1 = _np.linspace(0.125, 0.175, 30)
    mu_zoom_2 = _np.linspace(0.29, 0.34, 30)
    mu_zoom_3 = _np.linspace(0.45, 0.5, 30)
    mu_array = _np.append(mu_zoom_1, mu_zoom_2, mu_zoom_3)
